...
func set_icon_positions():
	if is_alex_interactable and is_sadie_interactable:
		alex_icon.global_position = icon_position
		sadie_icon.global_position = icon_position
		alex_icon.global_position.x -= 40
		sadie_icon.global_position.x += 40
	elif is_alex_interactable:
		alex_icon.global_position = icon_position
	elif is_sadie_interactable:
		sadie_icon.global_position = icon_position
		
	alex_icon.real_position = alex_icon.global_position
	sadie_icon.real_position = sadie_icon.global_position
